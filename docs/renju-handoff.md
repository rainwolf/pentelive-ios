...
- LIVE path **derives** the phase from echoes; TURN-BASED **reads** the server-shipped `renjuPhase` and submits via the `renjuAction` contract (§2.4 — five actions: swap/branch/offer/select + the move4 fold).
