...
@property(nonatomic, retain) NSMutableArray *movesList, *captures,
    *receivedMessages;
@property(nonatomic, retain) NSString *receivedMessage, *replyMessage,
...
@property(strong, nonatomic)
    IBOutlet UILongPressGestureRecognizer *boardTapRecognizer;
...
//-(void) detectKeryoCaptureOfOpponent: (int) opponentColor atPosition: (int)
// rowCol;
