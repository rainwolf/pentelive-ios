...
@interface InviteAIViewController
    : UITableViewController <SimplePickerInputTableViewCellDelegate> {
    NSMutableArray<NSString *> *games, *colors, *difficulties;
    NSString *game;
    BOOL openInvitationOnly;
}
@property(nonatomic, retain) NSMutableArray<NSString *> *games, *difficulties,
    *colors;
...
@property(weak, nonatomic)
    IBOutlet SimplePickerInputTableViewCell *opponentCell;
