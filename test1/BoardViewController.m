...
- (void)replayGame {
    ...
    atMoves =
        [NSMutableArray arrayWithArray:[jsonResponse[@"messageNums"]
                                           componentsSeparatedByString:@","]];
    messages =
        [NSMutableArray arrayWithArray:[jsonResponse[@"messages"]
                                           componentsSeparatedByString:@","]];
    ...
    //    isEqualToString:@"rainwolf"] && !go) {
    //        if ([[[@"samywamy-" stringByAppendingString:[[NSUserDefaults
    //        standardUserDefaults] objectForKey:@"password"]] SHA256]
    //        isEqualToString:@"1b7017087c9d8ff0d2b3ec1cb930273529d7efb52ce859e2dd1a824194ab7806"])
    //        {
    //            [lockButton setImage:[UIImage imageNamed:@"database.png"]
    //            forState:UIControlStateNormal]; [lockButton removeTarget:self
    //            action:@selector(toggleBoardLock:)
    //            forControlEvents:UIControlEventTouchUpInside]; [lockButton
    //            addTarget:self action:@selector(toDB)
    //            forControlEvents:UIControlEventTouchUpInside]; [lockButton
    //            setAlpha:1.0f]; [lockButton setEnabled:YES]; [lockButton
    //            setNeedsDisplay];
    //        }
    //    }
}
