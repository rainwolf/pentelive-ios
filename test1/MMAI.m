...
int mxvt[]={0,1,3,4,6,7,8,9,10,12,13,14,15, 18,18,18,18,18,18};
int mxvf[]={0,1,4,5,7,8,10,11,13,15,16,17,18, 18,18,18,18,18,18};
...
const int om3[] = {183,184,202,221,240,260,239,238,237,256,236,235,
...
-(instancetype) init {
    if (self = [super init]) {
        ...
        [self reset];
        NSString *path = [[NSBundle mainBundle] pathForResource:@"pente" ofType:@"tbl"];
